...
function reveal1() {
    ...
    Lateralus.classList.toggle("hidden");
    LateralusVideo.classList.toggle("hidden");
    LateralusVideo.play();
    console.log("Test");
}
...
function reveal2() {
    ...
    sidVerstappenImg.classList.toggle("hidden");
    sidVerstappenVideo.classList.toggle("hidden");
...
function reveal3() {
    ...
    PUPHymnImg.classList.toggle("hidden");
    PUPHymnVid.classList.toggle("hidden");
    PUPHymnVid.play();
    console.log("Test");
}